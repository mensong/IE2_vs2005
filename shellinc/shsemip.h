...
WINSHELLAPI HRESULT       WINAPI SHILCreateFromPath(LPCWSTR szPath, LPITEMIDLIST *ppidl, DWORD *rgfInOut);
 ...
 */
WINSHELLAPI BOOL WINAPI SHObjectProperties(HWND hwndOwner, DWORD dwType, LPCWSTR lpObject, LPCWSTR lpPage);
...
WINSHELLAPI BOOL  WINAPI PathIsExe(LPCWSTR lpszPath);
...
WINSHELLAPI BOOL  WINAPI PathMakeUniqueName(LPWSTR pszUniqueName, UINT cchMax, LPCWSTR pszTemplate, LPCWSTR pszLongPlate, LPCWSTR pszDir);
...
WINSHELLAPI void  WINAPI PathQualify(LPWSTR lpsz);
WINSHELLAPI int   WINAPI PathResolve(LPWSTR pszPath, LPCWSTR dirs[], UINT fFlags);
...
WINSHELLAPI int   WINAPI RestartDialog(HWND hwnd, LPCWSTR lpPrompt, DWORD dwReturn);
...
WINSHELLAPI BOOL  WINAPI GetFileNameFromBrowse(HWND hwnd, LPWSTR pszFilePath, UINT cbFilePath,
...
//WINSHELLAPI STDAPI SHCLSIDFromString(PCWSTR lpsz, CLSID * lpclsid);
...
WINSHELLAPI BOOL WINAPI SHObjectProperties(HWND hwnd, DWORD dwType, LPCWSTR lpObject, LPCWSTR lpPage);
