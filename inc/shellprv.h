...
BOOL WINAPI IsLFNDrive(LPCTSTR pszDriveRoot);
...
int WINAPI SHCreateDirectory(HWND hwnd, LPCTSTR szDest);
...
extern UINT WINAPI ExtractIcons(LPCTSTR szFileName, int nIconIndex, int cxIcon, int cyIcon, HICON *phicon, UINT *piconid, UINT nIcons, UINT flags);
