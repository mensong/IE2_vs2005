...
BOOL
jpeg_network_pushbytes (struct jpeg_decompress_struct* cinfo, unsigned char *pdata, int len, BOOL bForceFlush)
{
    my_src_ptr src;
...
unsigned char *
ReadJPEG_Dithered(void *pdecoderObject, unsigned char *data, long len, long *width, long *height)
{
...
unsigned char *
ReadJPEG_Dithered_VGA(void *pdecoderObject, unsigned char *data, long len, long *width, long *height)
{
    return ReadJPEG(data, len, width, height, DITHER_VGA);
}

unsigned char *
ReadJPEG_RGB(void *pdecoderObject, unsigned char *data, long len, long *width, long *height)
{
