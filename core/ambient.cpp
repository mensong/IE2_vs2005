	 ...
	 DISPPARAMS * pDispParams, VARIANT *pVarResult, EXCEPINFO *pExcepInfo, UINT *puArgErr)
{
	...
	{
		pVarResult->__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_BOOL;
		pVarResult->__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.boolVal = TRUE;
		return S_OK;
	}
	if ((pVarResult != NULL) && (wFlags == DISPATCH_PROPERTYGET) && (DispId == DISPID_AMBIENT_SHOWHATCHING))
	{
		pVarResult->__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_BOOL;
		pVarResult->__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.boolVal = FALSE;
		return S_OK;
	}
