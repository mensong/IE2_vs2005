...
DWORD WINAPI NPSAuthenticationDialogA(LPAUTHDLGSTRUCTA 	lpAuthDlgStruct	)
{
    ...
    //TRACE("%s %s %s\n",lpAuthDlgStruct->lpResource, lpAuthDlgStruct->lpOUTitle, lpAuthDlgStruct->lpExplainText);
__asm int 3;
    return DialogBoxParamW( hwininet, MAKEINTRESOURCEW( 1 ) /*MAKEINTRESOURCEW( IDD_PROXYDLG )*/,
