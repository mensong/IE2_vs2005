...
int ProcDetach()
{
    TCHAR       lpszLsaDLL[] = TEXT("advapi32.dll");
...
//
    ...
    *OutputTokenSize = AuthenticateMessageSize;
                                   ...
                                   NTLMSSP_NEGOTIATE_SEAL))
    {
        ...
        Context->ReceiveKey = (RC4_KEYSTRUCT *)SspAlloc(sizeof(RC4_KEYSTRUCT));
        if (Context->ReceiveKey == NULL)
        {
            SecStatus = SEC_E_INSUFFICIENT_MEMORY;
            goto Cleanup;
        }
        Context->SendKey = (RC4_KEYSTRUCT *)SspAlloc(sizeof(RC4_KEYSTRUCT));
