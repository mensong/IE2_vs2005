...
PUBLIC_DATA extern UINT g_cfURL;
PUBLIC_DATA extern UINT g_cfFileGroupDescriptor;
PUBLIC_DATA extern UINT g_cfFileContents;
...
PRIVATE_DATA extern char s_szURLCF[];//                   = "UniformResourceLocator";
PRIVATE_DATA /*extern*/ char s_szFileGroupDescriptorCF[]   = "FileGroupDescriptor"; // CFSTR_FILEDESCRIPTOR;
PRIVATE_DATA extern char s_szFileContentsCF[];//          = "FileContents"; // CFSTR_FILECONTENTS;
...
PRIVATE_CODE BOOL RegisterClipboardFormats(void)
{
   g_cfURL                 = RegisterClipboardFormatA(s_szURLCF);
   g_cfFileGroupDescriptor = RegisterClipboardFormatA(s_szFileGroupDescriptorCF);
...
{
   return(RegisterClipboardFormats());
}
