                               ...
                               PSTR pszCmdLine, int nShowCmd)
{
   ...
   else
   {
      if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                   MAKEINTRESOURCEA(IDS_LOADFROMFILE_FAILED),
                                           ...
                                           PSTR pszCmdLine, int nShowCmd)
{
   ...
   hinstExec = ShellExecuteA(hwndParent, pcszVerb, pszCmdLine, NULL, NULL,
                            nShowCmd);
   ...
   else
   {
      ...
      if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                   MAKEINTRESOURCEA(IDS_SHELLEXECUTE_FAILED),
                   (MB_OK | MB_ICONEXCLAMATION), &nResult, pszCmdLine))
         ASSERT(nResult == IDOK);
   }
                                             ...
                                             PSTR pszCmdLine, int nShowCmd)
{
   ...
   if (GetProfileStringA(s_cszMAPISection, s_cszMAPIKey, EMPTY_STRING,
                        szMAPIDLL, sizeof(szMAPIDLL)) > 0)
   {
      ...
      hinstMAPI = LoadLibraryA(szMAPIDLL);
      ...
      if (hinstMAPI)
      {
         ...
         if (MAPISendMailProc)
         {
            ...
            {
               if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                            MAKEINTRESOURCEA(IDS_MAPI_MAPISENDMAIL_FAILED),
         ...
         {
            if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                         MAKEINTRESOURCEA(IDS_MAPI_GETPROCADDRESS_FAILED),
                         (MB_OK | MB_ICONEXCLAMATION), &nResult,
      ...
      {
         if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                      MAKEINTRESOURCEA(IDS_MAPI_LOADLIBRARY_FAILED),
   ...
   {
      if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                   MAKEINTRESOURCEA(IDS_NO_MAPI_PROVIDER),
                   (MB_OK | MB_ICONEXCLAMATION), &nResult))
         ASSERT(nResult == IDOK);
   }
                                           ...
                                           PSTR pszCmdLine, int nShowCmd)
{
   ...
   hinstNews = LoadLibraryA(s_cszNewsDLL);
   ...
   if (hinstNews)
   {
      ...
      {
         if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                      MAKEINTRESOURCEA(IDS_NEWS_GETPROCADDRESS_FAILED),
                      (MB_OK | MB_ICONEXCLAMATION), &nResult))
            ASSERT(nResult == IDOK);
      }
   ...
   {
      if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                   MAKEINTRESOURCEA(IDS_NEWS_LOADLIBRARY_FAILED),
                   (MB_OK | MB_ICONEXCLAMATION), &nResult))
         ASSERT(nResult == IDOK);
   }
                                             ...
                                             PSTR pszCmdLine, int nShowCmd)
{
   ...
   switch (hr)
   {
      ...
      case E_FILE_NOT_FOUND:
         if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                      MAKEINTRESOURCEA(IDS_TELNET_APP_NOT_FOUND),
                      (MB_OK | MB_ICONEXCLAMATION), &nResult,
                      s_cszTelnetApp))
            ASSERT(nResult == IDOK);
         break;
      ...
      case E_OUTOFMEMORY:
         if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                      MAKEINTRESOURCEA(IDS_OPEN_INTSHCUT_OUT_OF_MEMORY),
                      (MB_OK | MB_ICONEXCLAMATION), &nResult))
            ASSERT(nResult == IDOK);
         break;
      ...
      default:
         ASSERT(hr == E_FAIL);
         if (MyMsgBox(hwndParent, MAKEINTRESOURCEA(IDS_SHORTCUT_ERROR_TITLE),
                      MAKEINTRESOURCEA(IDS_TELNET_EXEC_FAILED),
                      (MB_OK | MB_ICONEXCLAMATION), &nResult,
                      s_cszTelnetApp))
            ASSERT(nResult == IDOK);
         break;
